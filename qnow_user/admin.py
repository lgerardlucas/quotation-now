...
class UserAdmin(admin.ModelAdmin):
    ...
    'username','email','role','phone','cep','street','district','city','state','approved','is_active','contract_accepted','contract_date_accepted','birth_date','delivery_time','form_payment')
